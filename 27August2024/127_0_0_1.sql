...
(24, 'shirt', 'Designing Shirt with Contrast on front and Cuff - Dark Blue - Stylzzz\r\nShipment: 24 – 48 hours via Cash on Delivery Availability: Within 7-10 Working Days Delivery Charges: Free with In The Pakistan', '0', 0, 0),
(26, 'white shirt', 'COS - Contemporary Style, Designed To Last - Shop Online - GB\r\nInnovative design. Wardrobe essentials. More sustainable collections: COS is a fashion brand for women and men. Explore now', '455', 4, 5),
(27, 'black shirt', 'Feature, it has short sleeves and a round neckline, known as a crew neck, which lacks a collar. T-shirts are generally made of stretchy, light, and inexpensive fabric and are easy to clean.', '774', 74, 1);
...
(2, 'jamil@gamil.com', '123456', 'hossain');
...
--
-- Database: `wdpf60_tranctions`
--
CREATE DATABASE IF NOT EXISTS `wdpf60_tranctions` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `wdpf60_tranctions`;
