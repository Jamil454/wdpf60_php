                    ...
                    <div class="card card-pages shadow-none mt-4">
                        <div class="card-body">
                            <div class="text-center mt-0 mb-3">
                                ...
                                <p class="text-muted w-75 mx-auto mb-4 mt-4">Enter your email address and password</p>
                            </div>
                            ...
                            <form class="form-horizontal mt-4" action="login.php" method="post">
                                ...
                                <div class="form-group">
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" type="text" required="" id="email" placeholder="Email" name="email">
                                    </div>
                                </div>
